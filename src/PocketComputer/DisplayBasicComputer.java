...
public class DisplayBasicComputer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtDisplay.setTabSize(16);
        txtDisplay.setAlignmentX(1.0F);
        txtDisplay.setAlignmentY(1.0F);
        ...
        jButton17.setMaximumSize(new java.awt.Dimension(72, 29));
        jButton17.setMinimumSize(new java.awt.Dimension(72, 29));
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
       String NumarIntrodus = txtDisplay.getText()+jButton10.getText();
        txtDisplay.setText(NumarIntrodus);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String NumarIntrodus = txtDisplay.getText()+jButton1.getText();
        txtDisplay.setText(NumarIntrodus);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String NumarIntrodus = txtDisplay.getText()+jButton2.getText();
        txtDisplay.setText(NumarIntrodus);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String NumarIntrodus = txtDisplay.getText()+jButton3.getText();
        txtDisplay.setText(NumarIntrodus);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
         String NumarIntrodus = txtDisplay.getText()+jButton4.getText();
        txtDisplay.setText(NumarIntrodus);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        String NumarIntrodus = txtDisplay.getText()+jButton5.getText();
        txtDisplay.setText(NumarIntrodus);
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String NumarIntrodus = txtDisplay.getText()+jButton6.getText();
        txtDisplay.setText(NumarIntrodus);
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        String NumarIntrodus = txtDisplay.getText()+jButton7.getText();
        txtDisplay.setText(NumarIntrodus);
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        String NumarIntrodus = txtDisplay.getText()+jButton8.getText();
        txtDisplay.setText(NumarIntrodus);
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        String NumarIntrodus = txtDisplay.getText()+jButton9.getText();
        txtDisplay.setText(NumarIntrodus);
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        String NumarIntrodus = txtDisplay.getText()+".";
        txtDisplay.setText(NumarIntrodus);
    }//GEN-LAST:event_jButton16ActionPerformed

    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        double operatorspecial = Double.parseDouble(String.valueOf(txtDisplay.getText()));
        operatorspecial = operatorspecial * (-1);
        txtDisplay.setText(String.valueOf(operatorspecial));
    }//GEN-LAST:event_jButton18ActionPerformed

    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        firstnum = Double.parseDouble(txtDisplay.getText());
        txtDisplay.setText(String.valueOf(firstnum/100));
        operation="%";
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        switch(operation){
            case "+":
                rezultat = firstnum + secondnum;
                raspuns = String.format("%.2f",rezultat);
                txtDisplay.setText(raspuns);
                break;
            case "-":
                rezultat = firstnum - secondnum;
                raspuns = String.format("%.1f",rezultat);
                txtDisplay.setText(raspuns);
                break;     
            case "/":
                rezultat = firstnum/secondnum;
            ...
            case "%":
                rezultat = firstnum % secondnum;
                raspuns = String.format("%.5f",rezultat);
                txtDisplay.setText(raspuns);
                break;   
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DisplayBasicComputer().setVisible(true);
            }
        });
    }
